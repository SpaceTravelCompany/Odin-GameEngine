...
foreign amidi {
	...
	* Available since API level 29.
	 */
	AMidiDevice_fromJava :: proc(env: ^android.JNIEnv, midiDeviceObj: android.jobject, outDevicePtrPtr: ^^AMidiDevice) -> media.media_status_t ---
	...
	* Available since API level 29.
	*/
	AMidiDevice_release :: proc(midiDevice: ^AMidiDevice) -> media.media_status_t ---
	...
	* Available since API level 29.
	*/
	AMidiOutputPort_open :: proc(device: ^AMidiDevice, portNumber: i32, outOutputPortPtr: ^^AMidiOutputPort) -> media.media_status_t ---
	...
	* Available since API level 29.
	*/
	AMidiInputPort_open :: proc(device: ^AMidiDevice, portNumber: i32, outInputPortPtr: ^^AMidiInputPort) -> media.media_status_t ---
	...
	* Available since API level 29.
	*/
	AMidiInputPort_sendFlush :: proc(inputPort: ^AMidiInputPort) -> media.media_status_t ---
