...
@private LIBOPUSFILE :: library.LIBPATH + "/libopusfile" + library.ARCH_end
...
OpusHead :: struct {
	...
	input_sample_rate:opus.opus_uint32,
  ...
  /**The mapping from coded stream channels to output channels.
    ...
    mapping:[OPUS_CHANNEL_COUNT_MAX]byte,
}
...
/**Reads up to \a _nbytes bytes of data from \a _stream.
   ...
   \return The number of bytes successfully read, or a negative value on
            error.*/
op_read_func :: #type proc "c" (_stream:rawptr, _ptr:[^]byte, _nbytes:c.int) -> c.int
...
op_seek_func :: #type proc "c" (_stream:rawptr, _offset:opus.opus_int64, _whence:c.int) -> c.int

/**Obtains the current value of the position indicator for \a _stream.
   \return The current position indicator.*/
op_tell_func :: #type proc "c" (_stream:rawptr) -> opus.opus_int64

/**Closes the underlying stream.
   \retval 0   Success.
   \retval EOF An error occurred.
               <code>errno</code> need not be set.*/
op_close_func :: #type proc "c" (_stream:rawptr) -> c.int

op_decode_cb_func :: #type proc "c" (_ctx:rawptr, _decoder:opus.OpusMSDecoder, _pcm:rawptr, _op:^ogg.ogg_packet, _nsample:c.int, _nchannels:c.int, _li:c.int) -> c.int
...
@(require_results) opus_head_parse :: proc(_head:OpusHead, _data:[^]byte, _len:c.size_t) -> c.int ---
 ...
 /**Converts a granule position to a sample offset for a given Ogg Opus stream.
    ...
    \return The sample offset associated with the given granule position
             ...
             amount).*/
  opus_granule_sample :: proc(_head:OpusHead, _gp:ogg.ogg_int64_t) -> ogg.ogg_int64_t ---
 ...
 @(require_results) opus_tags_parse :: proc(_tags:OpusTags, _data:[^]byte, _len:c.size_t) -> c.int ---
 ...
 opus_tags_copy :: proc(_dst:OpusTags, _src:OpusTags) -> c.int ---
 ...
 opus_tags_init :: proc(_tags:OpusTags) ---
 ...
 opus_tags_add :: proc(_tags:OpusTags, _tag:cstring, _value:cstring) -> c.int ---
 ...
 /**Add a comment to an initialized #OpusTags structure.
    ...
    \return 0 on success, or a negative value on failure.
    \retval #OP_EFAULT An internal memory allocation failed.*/
 opus_tags_add_comment :: proc(_tags:OpusTags, _comment:cstring) -> c.int ---
 ...
 /**Replace the binary suffix data at the end of the packet (if any).
    ...
    \retval #OP_EFAULT An internal memory allocation failed.*/
 opus_tags_set_binary_suffix :: proc(_tags:OpusTags, _data:[^]byte,_len:c.int) -> c.int ---
 ...
 opus_tags_query :: proc(_tags:OpusTags, _tag:cstring, _count:c.int) -> cstring ---
 ...
 opus_tags_query_count :: proc(_tags:OpusTags, _tag:cstring) -> c.int ---
 ...
 /**Retrieve the binary suffix data at the end of the packet (if any).
    ...
    \return A pointer to the binary suffix data, or <code>NULL</code> if none
             was present.*/
 opus_tags_get_binary_suffix :: proc(_tags:OpusTags, _len:^c.int) -> cstring ---
 ...
 /**Get the album gain from an R128_ALBUM_GAIN tag, if one was specified.
  ...
  opus_tags_get_album_gain :: proc(_tags:OpusTags, _gain_q8:^c.int) -> c.int ---
 ...
 opus_tags_get_track_gain :: proc(_tags:OpusTags, _gain_q8:^c.int) -> c.int ---
 ...
 opus_tags_clear :: proc(_tags:OpusTags) ---
 ...
 opus_tagcompare :: proc(_tag_name:cstring, _comment:cstring) -> c.int ---
 ...
 opus_tagncompare :: proc(_tag_name:cstring, _tag_len:c.int, _comment:cstring) -> c.int ---
 ...
 /**Parse a single METADATA_BLOCK_PICTURE tag.
    ...
    \retval #OP_EFAULT     There was not enough memory to store the picture tag
                            contents.*/
 @(require_results) opus_picture_tag_parse :: proc(_pic:OpusPictureTag, _tag:cstring) -> c.int ---
 ...
 opus_picture_tag_init :: proc(_pic:OpusPictureTag) ---
 ...
 opus_picture_tag_clear :: proc(_pic:OpusPictureTag) ---
...
opus_server_info_init :: proc(_info:OpusServerInfo) ---
...
/**Clears the #OpusServerInfo structure.
   ...
   \note If you use this function, you must link against <tt>libopusurl</tt>.*/
opus_server_info_clear :: proc(_info:OpusServerInfo) ---
...
/**Opens a stream with <code>fopen()</code> and fills in a set of callbacks
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
  @(require_results) op_fopen :: proc(_cb:^OpusFileCallbacks, _path:cstring, _mode:cstring) -> rawptr ---
    ...
    /**Opens a stream with <code>fdopen()</code> and fills in a set of callbacks
      ...
      \return A stream handle to use with the callbacks, or <code>NULL</code> on
                error.*/
  @(require_results) op_fdopen :: proc(_cb:^OpusFileCallbacks, _fd:c.int, _mode:cstring) -> rawptr ---
    ...
    /**Opens a stream with <code>freopen()</code> and fills in a set of callbacks
      ...
      \return A stream handle to use with the callbacks, or <code>NULL</code> on
                error.*/
    @(require_results) op_freopen :: proc(_cb:^OpusFileCallbacks, _path:cstring, _mode:cstring, _stream:rawptr) -> rawptr ---
    ...
    /**Creates a stream that reads from the given block of memory.
      ...
      \return A stream handle to use with the callbacks, or <code>NULL</code> on
                error.*/
    @(require_results) op_mem_stream_create :: proc(_cb:^OpusFileCallbacks, _data:[^]byte,_size:c.size_t) -> rawptr ---
    ...
    /**Creates a stream that reads from the given URL.
      ...
      \return A stream handle to use with the callbacks, or <code>NULL</code> on
                error.*/
    @(require_results) op_url_stream_vcreate :: proc(_cb:^OpusFileCallbacks, _url:cstring, _ap: ^c.va_list) -> rawptr ---
    ...
    /**Creates a stream that reads from the given URL.
      ...
      \return A stream handle to use with the callbacks, or <code>NULL</code> on
                error.*/
    @(require_results) op_url_stream_create :: proc(_cb:^OpusFileCallbacks, _url:cstring, #c_vararg args:..any) -> rawptr ---
    ...
    /**Test to see if this is an Opus stream.
      ...
      \retval #OP_EBADHEADER The ID header was not properly formatted or contained
                              illegal values.*/
    op_test :: proc(_head:OpusHead, _initial_data:[^]byte, _initial_bytes:c.size_t) -> c.int ---
    ...
    @(require_results) op_open_file :: proc(_path:cstring, _error:^c.int) -> ^OggOpusFile ---
    ...
    /**Open a stream from a memory buffer.
      ...
      \return A freshly opened \c ^OggOpusFile, or <code>NULL</code> on error.*/
    @(require_results) op_open_memory :: proc(_data:[^]byte, _size:c.size_t, _error:^c.int) -> ^OggOpusFile ---
    ...
    /**Open a stream from a URL.
      ...
      \param[in,out] _ap    A list of the \ref url_options "optional flags" to
                            ...
                            This is a variable-length list of options terminated
                              with <code>NULL</code>.
      \return A freshly opened \c ^OggOpusFile, or <code>NULL</code> on error.*/
    @(require_results) op_vopen_url :: proc(_url:cstring, _error:^c.int, _ap:^c.va_list) -> ^OggOpusFile ---
    ...
    /**Open a stream from a URL.
      ...
      \param      ...    The \ref url_options "optional flags" to use.
                          ...
                          <code>NULL</code>.
      \return A freshly opened \c ^OggOpusFile, or <code>NULL</code> on error.*/
      @(require_results) op_open_url :: proc(_url:cstring, _error:^c.int, #c_vararg args:..any) -> ^OggOpusFile ---
    ...
    @(require_results) op_open_callbacks :: proc(_stream:rawptr, _cb:^OpusFileCallbacks, _initial_data:[^]byte, _initial_bytes:c.size_t, _error:^c.int) -> ^OggOpusFile ---
    ...
    @(require_results) op_test_file :: proc(_path:cstring, _error:^c.int) -> ^OggOpusFile ---
    ...
    /**Partially open a stream from a memory buffer.
      ...
      \param[out] _error Returns 0 on success, or a failure code on error.
                          ...
                          See op_open_callbacks() for a full list of failure codes.
      \return A partially opened \c ^OggOpusFile, or <code>NULL</code> on error.*/
    @(require_results) op_test_memory :: proc(_data:[^]byte, _size:c.size_t, _error:^c.int) -> ^OggOpusFile---
    ...
    /**Partially open a stream from a URL.
      ...
      \param[in,out] _ap     A list of the \ref url_options "optional flags" to
                              ...
                              with <code>NULL</code>.
      \return A partially opened \c ^OggOpusFile, or <code>NULL</code> on error.*/
    @(require_results) op_vtest_url :: proc(_url:cstring, _error:^c.int, _ap:^c.va_list) -> ^OggOpusFile ---
    ...
    /**Partially open a stream from a URL.
      ...
      \param      ...     The \ref url_options "optional flags" to use.
                          This is a variable-length list of options terminated
                            with <code>NULL</code>.
      \return A partially opened \c ^OggOpusFile, or <code>NULL</code> on error.*/
      @(require_results) op_test_url :: proc(_url:cstring, _error:^c.int, #c_vararg args:..any) -> ^OggOpusFile ---
    ...
    /**Partially open a stream using the given set of callbacks to access it.
      ...
      \return A partially opened \c ^OggOpusFile, or <code>NULL</code> on error.
              ...
              The calling application is responsible for closing the stream if
                this call returns an error.*/
    @(require_results) op_test_callbacks :: proc(_stream:rawptr, _cb:^OpusFileCallbacks, _initial_data:[^]byte, _initial_bytes:c.size_t, _error:^c.int) -> ^OggOpusFile ---
    ...
    op_seekable :: proc(_of:^OggOpusFile) -> c.int ---
    ...
    op_link_count :: proc(_of:^OggOpusFile) -> c.int ---
    ...
    /**Get the serial number of the given link in a (possibly-chained) Ogg Opus
      ...
      \return The serial number of the given link.
              ...
              If the stream is not seekable, this always returns the serial number
                of the current link.*/
    op_serialno :: proc(_of:^OggOpusFile, _li:c.int) -> opus.opus_uint32 ---
    ...
    /**Get the channel count of the given link in a (possibly-chained) Ogg Opus
      ...
      \return The channel count of the given link.
              ...
              If the stream is not seekable, this always returns the channel count
                of the current link.*/
    op_channel_count :: proc(_of:^OggOpusFile, _li:c.int) -> c.int ---
    ...
    op_raw_total :: proc(_of:^OggOpusFile, _li:c.int) -> opus.opus_int64 ---
    ...
    /**Get the total PCM length (number of samples at 48 kHz) of the stream, or of
      ...
      \retval #OP_EINVAL The stream is not seekable (so we can't know the length),
                          \a _li wasn't less than the total number of links in
                          the stream, or the stream was only partially open.*/
    op_pcm_total :: proc(_of:^OggOpusFile, _li:c.int) -> opus.opus_int64 ---
    ...
    op_head :: proc(_of:^OggOpusFile, _li:c.int) -> ^OpusHead ---
    ...
    /**Get the comment header information for the given link in a (possibly
      ...
      \return The contents of the comment header for the given link, or
                ...
                an invalid link.*/
    op_tags :: proc(_of:^OggOpusFile, _li:c.int) -> ^OpusTags ---
    ...
    op_current_link :: proc(_of:^OggOpusFile) -> c.int ---
    ...
    /**Computes the bitrate of the stream, or of an individual link in a
      ...
      \retval #OP_EINVAL The stream was only partially open, the stream was not
                          ...
                          links.*/
    op_bitrate :: proc(_of:^OggOpusFile, _li:c.int) -> opus.opus_int32 ---
    ...
    /**Compute the instantaneous bitrate, measured as the ratio of bits to playable
      ...
      \retval #OP_FALSE  No data has been decoded since any of the events
                          described above.
      \retval #OP_EINVAL The stream was only partially open.*/
    op_bitrate_instant :: proc(_of:^OggOpusFile) -> opus.opus_int32 ---
    ...
    /**Obtain the current value of the position indicator for \a _of.
      ...
      \retval #OP_EINVAL The stream was only partially open.*/
    op_raw_tell :: proc(_of:^OggOpusFile) -> opus.opus_int64 ---
    ...
    /**Obtain the PCM offset of the next sample to be read.
      ...
      \retval #OP_EINVAL The stream was only partially open.*/
    op_pcm_tell :: proc(_of:^OggOpusFile) -> ogg.ogg_int64_t ---
    ...
    /**Seek to a byte offset relative to the <b>compressed</b> data.
      ...
      \retval #OP_EBADLINK Failed to initialize a decoder for a stream for an
                            unknown reason.*/
    op_raw_seek :: proc(_of:^OggOpusFile, _byte_offset:opus.opus_int64) -> c.int ---
    ...
    op_pcm_seek :: proc(_of:^OggOpusFile, _pcm_offset:opus.opus_int64) -> c.int ---
  ...
  op_set_decode_callback :: proc(_of:^OggOpusFile, _decode_cb:op_decode_cb_func, _ctx:rawptr) ---
  ...
  op_set_gain_offset :: proc(ehl_of:^OggOpusFile, _gain_type:c.int, _gain_offset_q8:opus.opus_int32) -> c.int ---
 ...
 op_set_dither_enabled :: proc(_of:^OggOpusFile, _enabled:b32) ---
 ...
 /**Reads more samples from the stream.
    ...
    \param[out] _pcm      A buffer in which to store the output PCM samples, as
                           signed native-endian 16-bit values at 48&nbsp ---kHz
    ...
    \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                               ...
                               checks.*/
 @(require_results) op_read :: proc(_of:^OggOpusFile, _pcm:[^]opus.opus_int16, _buf_size:c.int, _li:^c.int) -> c.int ---
 ...
 /**Reads more samples from the stream.
    ...
    \param      _of       The \c ^OggOpusFile from which to read.
    \param[out] _pcm      A buffer in which to store the output PCM samples as
                           signed floats at 48&nbsp ---kHz with a nominal range of
                           <code>[-1.0,1.0]</code>.
                          Multiple channels are interleaved using the
                           <a href="https://www.xiph.org/vorbis/doc/Vorbis_I_spec.html#x1-810004.3.9">Vorbis
                           channel ordering</a>.
    ...
    \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                               a starting timestamp that failed basic validity
                               checks.*/
 @(require_results) op_read_float :: proc(_of:^OggOpusFile, _pcm:[^]c.float, _buf_size:c.int, _li:^c.int) -> c.int ---
 ...
 /**Reads more samples from the stream and downmixes to stereo, if necessary.
    ...
    \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                               a starting timestamp that failed basic validity
                               checks.*/
 @(require_results) op_read_stereo :: proc(_of:^OggOpusFile, _pcm:[^]opus.opus_uint16, _buf_size:c.int) -> c.int ---
 ...
 /**Reads more samples from the stream and downmixes to stereo, if necessary.
    ...
    \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                               a starting timestamp that failed basic validity
                               checks.*/
  @(require_results) op_read_float_stereo :: proc(_of:^OggOpusFile, _pcm:[^]c.float, _buf_size:c.int) -> c.int ---
}