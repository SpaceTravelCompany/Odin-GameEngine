...
BROTLI_COMMON_LIB :: #directory + library.LIBPATH + "/libbrotlicommon" + library.ARCH_end
BROTLI_DEC_LIB :: #directory + library.LIBPATH + "/libbrotlidec" + library.ARCH_end
BROTLI_ENC_LIB :: #directory + library.LIBPATH + "/libbrotlienc" + library.ARCH_end
